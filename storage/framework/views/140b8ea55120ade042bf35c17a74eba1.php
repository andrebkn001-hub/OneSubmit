...
<?php $__env->startSection('content'); ?>
    ...
    <?php if($pendingProposals > 0 || $pendingKjfd > 0 || $revisiProposals > 0): ?>
        <div class="row mb-3">
            <div class="col-12">
                <?php if($pendingProposals > 0): ?>
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <i class="bi bi-exclamation-triangle-fill"></i>
                        <strong>Perhatian!</strong> Ada <strong><?php echo e($pendingProposals); ?></strong> proposal yang menunggu verifikasi dari Anda.
                        <a href="<?php echo e(route('admin.proposals.index')); ?>" class="alert-link">Lihat Sekarang</a>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php endif; ?>
                <?php if($pendingKjfd > 0): ?>
                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                        <i class="bi bi-info-circle-fill"></i>
                        Ada <strong><?php echo e($pendingKjfd); ?></strong> proposal sedang dalam verifikasi Dosen KJFD.
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php endif; ?>
                <?php if($revisiProposals > 0): ?>
                    <div class="alert alert-secondary alert-dismissible fade show" role="alert">
                        <i class="bi bi-arrow-repeat"></i>
                        Ada <strong><?php echo e($revisiProposals); ?></strong> proposal yang perlu direvisi oleh mahasiswa.
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="card text-white bg-primary mb-3 shadow-sm hover-card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div style="position: relative; z-index: 1;">
                        ...
                        <h2 class="card-text mb-0 fw-bold"><?php echo e($kpi['total'] ?? 0); ?></h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card text-white bg-success mb-3 shadow-sm hover-card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div style="position: relative; z-index: 1;">
                        ...
                        <h2 class="card-text mb-0 fw-bold"><?php echo e($kpi['approved'] ?? 0); ?></h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card text-white bg-warning mb-3 shadow-sm hover-card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div style="position: relative; z-index: 1;">
                        ...
                        <h2 class="card-text mb-0 fw-bold"><?php echo e($kpi['pending'] ?? 0); ?></h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card text-white bg-danger mb-3 shadow-sm hover-card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div style="position: relative; z-index: 1;">
                        ...
                        <h2 class="card-text mb-0 fw-bold"><?php echo e($kpi['rejected'] ?? 0); ?></h2>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row text-center">
                            <div class="col">
                                <div class="status-box">
                                    ...
                                    <h4 class="mt-2 mb-0 fw-bold"><?php echo e($statusStats['menunggu_verifikasi'] ?? 0); ?></h4>
                                </div>
                            </div>
                            <div class="col">
                                <div class="status-box">
                                    ...
                                    <h4 class="mt-2 mb-0 fw-bold"><?php echo e($statusStats['menunggu_verifikasi_dosen_kjfd'] ?? 0); ?></h4>
                                </div>
                            </div>
                            <div class="col">
                                <div class="status-box">
                                    ...
                                    <h4 class="mt-2 mb-0 fw-bold"><?php echo e($statusStats['disetujui'] ?? 0); ?></h4>
                                </div>
                            </div>
                            <div class="col">
                                <div class="status-box">
                                    ...
                                    <h4 class="mt-2 mb-0 fw-bold"><?php echo e($statusStats['ditolak'] ?? 0); ?></h4>
                                </div>
                            </div>
                            <div class="col">
                                <div class="status-box">
                                    ...
                                    <h4 class="mt-2 mb-0 fw-bold"><?php echo e($statusStats['revisi'] ?? 0); ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row text-center">
                        <div class="col-6">
                            ...
                            <h5 class="mt-2 fw-bold"><?php echo e($userStats['active_7days']); ?></h5>
                        </div>
                        <div class="col-6">
                            <span class="badge bg-info">
                                <i class="bi bi-calendar"></i> Aktif 30 Hari
                            </span>
                            <h5 class="mt-2 fw-bold"><?php echo e($userStats['active_30days']); ?></h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form id="filterForm" method="GET" action="<?php echo e(route('admin.dashboard')); ?>">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <select name="status" id="filterStatus" class="form-select">
                                    ...
                                    <option value="menunggu_verifikasi_dosen_kjfd" <?php echo e(request('status') == 'menunggu_verifikasi_dosen_kjfd' ? 'selected' : ''); ?>>Menunggu Verifikasi Dosen KJFD</option>
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="bidang" id="filterBidang" class="form-select">
                                    ...
                                    <?php $__currentLoopData = $counts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bidang => $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($bidang); ?>" <?php echo e(request('bidang') == $bidang ? 'selected' : ''); ?>><?php echo e($bidang); ?></option>
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="date" name="date_from" id="filterDateFrom" class="form-control" value="<?php echo e(request('date_from')); ?>">
                            </div>
                            <div class="col-md-2">
                                <label for="filterDateTo" class="form-label">
                                    <i class="bi bi-calendar-check"></i> Sampai Tanggal
                                </label>
                                <input type="date" name="date_to" id="filterDateTo" class="form-control" value="<?php echo e(request('date_to')); ?>">
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-10">
                                <input type="text" name="search" id="searchBox" class="form-control" placeholder="🔍 Cari judul proposal, NIM, atau nama mahasiswa..." value="<?php echo e(request('search')); ?>">
                            </div>
                            <div class="col-md-2">
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <?php if(!empty($allProposals) && $allProposals->isNotEmpty()): ?>
                        <div class="table-responsive">
                            <table id="proposalTable" class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $allProposals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($loop->iteration); ?></td>
                                            <td><?php echo e($proposal->nim); ?></td>
                                            <td><?php echo e($proposal->user->name ?? $proposal->nama_lengkap); ?></td>
                                            <td>
                                                <a href="#" class="text-primary" data-bs-toggle="modal" data-bs-target="#quickViewModal" 
                                                   data-id="<?php echo e($proposal->id); ?>"
                                                   data-nim="<?php echo e($proposal->nim); ?>"
                                                   data-nama="<?php echo e($proposal->user->name ?? $proposal->nama_lengkap); ?>"
                                                   data-judul="<?php echo e($proposal->judul); ?>"
                                                   data-bidang="<?php echo e($proposal->bidang_minat); ?>"
                                                   data-status="<?php echo e($proposal->getStatusLabel()); ?>"
                                                   data-tanggal="<?php echo e($proposal->created_at->format('d M Y H:i')); ?>"
                                                   data-file="<?php echo e($proposal->file_path); ?>"
                                                   onclick="loadQuickView(this)">
                                                    <?php echo e($proposal->judul); ?>

                                                </a>
                                            </td>
                                            <td><?php echo e($proposal->bidang_minat); ?></td>
                                            <td><span class="badge text-bg-<?php echo e($proposal->getStatusBadgeColor()); ?>"><?php echo e($proposal->getStatusLabel()); ?></span></td>
...
function initializeCharts() {
    // Chart Proposal per Bidang Minat
    var bidangLabels = <?php echo json_encode(array_keys($counts->toArray())); ?>;
    var bidangData = <?php echo json_encode(array_values($counts->toArray())); ?>;
    ...
    var trendLabels = <?php echo json_encode($trend['labels'] ?? []); ?>;
    var trendData = <?php echo json_encode($trend['data'] ?? []); ?>;
    ...
    // Chart User Growth
    var userGrowthLabels = <?php echo json_encode($userGrowth['labels'] ?? []); ?>;
    var userGrowthData = <?php echo json_encode($userGrowth['data'] ?? []); ?>;
...
function loadQuickView(element) {
    ...
    document.getElementById('viewFileBtn').href = '<?php echo e(route("admin.proposals.view-file", ":id")); ?>'.replace(':id', proposalId);
    document.getElementById('manageProposalBtn').href = '<?php echo e(route("admin.proposals.index")); ?>?id=' + proposalId;
}
</script>
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\OneSubmit\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>