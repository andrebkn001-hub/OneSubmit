                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div>
                            ...
                            <p class="text-sm sm:text-base text-blue-100 flex items-center">
                                ...
                                Total: <span class="font-bold ml-1"><?php echo e(count($dosenStaff)); ?></span> orang
                            </p>
                        </div>
                ...
                <div class="overflow-x-auto">
                    <table id="dosenStaffTable" class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            <?php $__currentLoopData = $dosenStaff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $person): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 transition-all duration-300 group">
                                    ...
                                    <td class="px-6 py-5">
                                        ...
                                        ?>
                                        <span class="inline-flex items-center px-4 py-2 text-xs sm:text-sm font-semibold rounded-xl shadow-sm <?php echo e($badgeClass); ?>">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                                            </svg>
                                            <?php echo e($person['jabatan']); ?>

                                        </span>
                                    </td>
                                    <td class="px-6 py-5 whitespace-nowrap text-sm text-gray-600 font-mono">
                                        <?php echo e($person['nip'] ?: '-'); ?>
...
<?php /**PATH C:\laragon\www\OneSubmit\resources\views/dosen-staff.blade.php ENDPATH**/ ?>