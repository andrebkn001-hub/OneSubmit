                        ...
                        <div class="col-lg-8">
                            <div class="d-flex align-items-center text-white">
                                <div class="icon-box me-3" style="width: 60px; height: 60px; background: rgba(255,255,255,0.2); border-radius: 15px; display: flex; align-items: center; justify-content: center;">
                                    ...
                                    ?>
                                    <i class="fas fa-<?php echo e($icon); ?> fa-2x"></i>
                                </div>
                                <div>
                                    <h2 class="mb-1 fw-bold">Daftar Proposal Mahasiswa</h2>
                                    <p class="mb-0 opacity-75">
                                        <i class="fas fa-tag me-2"></i>Bidang: <strong><?php echo e($bidang); ?></strong>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 text-lg-end mt-3 mt-lg-0">
                            <a href="<?php echo e(route('jurusan.proposals.kjfd')); ?>" class="btn btn-light btn-lg px-4 py-2" style="border-radius: 12px; font-weight: 600;">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold text-success"><?php echo e($disetujui); ?></h3>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold text-warning"><?php echo e($pending); ?></h3>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold text-danger"><?php echo e($ditolak); ?></h3>
                        </div>
        ...
        <div class="card-header bg-white border-0 p-4" style="border-radius: 20px 20px 0 0;">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                <div class="mb-2 mb-md-0">
                    ...
                    <p class="text-muted mb-0 small">Semua proposal yang diajukan pada bidang <?php echo e($bidang); ?></p>
                </div>
                            ...
                            <tr style="transition: all 0.3s ease;">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-circle me-2" style="width: 35px; height: 35px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold; font-size: 14px;">
                                            <?php echo e(strtoupper(substr($proposal->nama_lengkap, 0, 1))); ?>

                                        </div>
                                        <span class="fw-semibold"><?php echo e($proposal->nama_lengkap); ?></span>
                                    </div>
                                </td>
                                <td>
                                    <span class="badge bg-secondary bg-opacity-10 text-secondary px-3 py-2" style="font-size: 0.9rem; font-weight: 600;">
                                        <?php echo e($proposal->nim); ?>

                                    </span>
                                </td>
                                <td>
                                    <div class="proposal-title" style="max-width: 350px;">
                                        <span class="text-dark" title="<?php echo e($proposal->judul); ?>">
                                            <?php echo e(Str::limit($proposal->judul, 80)); ?>
                                ...
                                <td>
                                    <div class="d-flex flex-column">
                                        <span class="fw-semibold text-dark"><?php echo e($proposal->created_at->format('d M Y')); ?></span>
                                        <small class="text-muted"><?php echo e($proposal->created_at->format('H:i')); ?> WIB</small>
                                    </div>
                                </td>
                                <td>
                                    <?php
                            ...
                            <tr>
                                <td colspan="7" class="text-center py-5">
                                    <div class="empty-state">
                                        ...
                                        <p class="text-muted mb-0">Belum ada proposal yang diajukan untuk bidang <?php echo e($bidang); ?>.</p>
                                    </div>
                                </td>
                            </tr>
                        <?php endif; ?>
            ...
            buttons: [
                {
                    ...
                    title: 'Daftar Proposal - <?php echo e($bidang); ?>',
                    filename: 'Proposal_<?php echo e(str_replace(" ", "_", $bidang)); ?>_' + new Date().toISOString().slice(0,10),
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4, 5],
                        format: {
