    ...
    <div class="row mb-5">
        <div class="col-12">
            <div class="text-center">
                ...
                <p class="lead text-muted">Selamat datang, <strong class="text-primary"><?php echo e(Auth::user()->name); ?></strong></p>
                <div class="mt-4">
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card h-100 border-0 shadow-lg hover-card" style="background: linear-gradient(135deg, #e3f2fd 0%, #bbdefb 100%); border-radius: 15px;">
                <div class="card-body text-center p-4">
                    ...
                    <a href="<?php echo e(route('mahasiswa.proposal.create')); ?>" class="btn btn-primary btn-lg w-100 fw-bold" style="background: linear-gradient(135deg, #1976d2 0%, #1565c0 100%); border: none; border-radius: 10px;">
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card h-100 border-0 shadow-lg hover-card" style="background: linear-gradient(135deg, #f3e5f5 0%, #e1bee7 100%); border-radius: 15px;">
                <div class="card-body text-center p-4">
                    ...
                    <a href="<?php echo e(route('mahasiswa.status')); ?>" class="btn btn-primary btn-lg w-100 fw-bold" style="background: linear-gradient(135deg, #7b1fa2 0%, #6a1b9a 100%); border: none; border-radius: 10px;">
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card h-100 border-0 shadow-lg hover-card" style="background: linear-gradient(135deg, #e8f5e8 0%, #c8e6c9 100%); border-radius: 15px;">
                <div class="card-body text-center p-4">
                    ...
                    <a href="<?php echo e(route('profile.edit')); ?>" class="btn btn-primary btn-lg w-100 fw-bold" style="background: linear-gradient(135deg, #388e3c 0%, #2e7d32 100%); border: none; border-radius: 10px;">
                        ...
                        <div class="col-6 col-md-3">
                            <div class="stats-card text-center p-4 rounded-3" style="background: linear-gradient(135deg, #fff3cd 0%, #ffeaa7 100%); border: 2px solid #ffc107;">
                                <div class="stats-number fw-bold fs-1 mb-2" style="color: #856404;">
                                    <?php echo e(\App\Models\Proposal::where('user_id', auth()->id())->where('status', 'menunggu_verifikasi')->count()); ?>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="stats-card text-center p-4 rounded-3" style="background: linear-gradient(135deg, #cce5ff 0%, #99d6ff 100%); border: 2px solid #0d6efd;">
                                <div class="stats-number fw-bold fs-1 mb-2" style="color: #0a58ca;">
                                    <?php echo e(\App\Models\Proposal::where('user_id', auth()->id())->where('status', 'menunggu_verifikasi_dosen_kjfd')->count()); ?>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="stats-card text-center p-4 rounded-3" style="background: linear-gradient(135deg, #d1ecf1 0%, #a3daff 100%); border: 2px solid #198754;">
                                <div class="stats-number fw-bold fs-1 mb-2" style="color: #0f5132;">
                                    <?php echo e(\App\Models\Proposal::where('user_id', auth()->id())->where('status', 'disetujui')->count()); ?>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="stats-card text-center p-4 rounded-3" style="background: linear-gradient(135deg, #f8d7da 0%, #f5c6cb 100%); border: 2px solid #dc3545;">
                                <div class="stats-number fw-bold fs-1 mb-2" style="color: #b02a37;">
                                    <?php echo e(\App\Models\Proposal::where('user_id', auth()->id())->where('status', 'ditolak')->count()); ?>
                    ...
                    <?php else: ?>
                        <div class="table-responsive">
                            <table id="kjfdQuotasTable" class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $kjfdList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kjfd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            ...
                                            <td class="py-3 px-4 fw-semibold">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-circle me-3" style="width: 40px; height: 40px; background: linear-gradient(135deg, #1976d2 0%, #1565c0 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold;">
                                                        <?php echo e(substr($kjfd->name, 0, 1)); ?>

                                                    </div>
                                                    <?php echo e($kjfd->name); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\OneSubmit\resources\views/mahasiswa/dashboard.blade.php ENDPATH**/ ?>