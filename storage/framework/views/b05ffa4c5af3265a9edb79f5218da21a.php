...
<body class="antialiased bg-gradient-to-br from-sky-400 via-sky-500 to-sky-600" style="background-image: url('<?php echo e(asset('images/hero-bg.jpg')); ?>'); background-size: cover; background-position: center; background-repeat: no-repeat;">
    ...
    <section class="relative bg-gradient-to-br from-sky-400 via-sky-500 to-sky-600 text-white py-16 overflow-hidden">
        <!-- Background Image -->
        <div class="absolute inset-0 bg-cover bg-center bg-no-repeat" style="background-image: url('<?php echo e(asset('images/hero-bg.jpg')); ?>');"></div>
...
<?php /**PATH C:\laragon\www\OneSubmit\resources\views/landing.blade.php ENDPATH**/ ?>