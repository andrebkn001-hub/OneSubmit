    ...
    <div class="row mb-2 mb-md-4">
        <div class="col-12">
            <div class="text-center">
                ...
                <p class="lead-text text-muted mb-2">Selamat datang, <strong class="text-primary"><?php echo e(Auth::user()->name); ?></strong></p>
                <div class="mt-2 d-none d-md-block">
                    <img src="<?php echo e(asset('images/unri.png')); ?>" alt="UNRI Logo" class="img-fluid unri-logo">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card h-100 border-0 shadow hover-card action-card gradient-blue rounded-3">
                <div class="card-body text-center card-body-responsive unified-card">
                    ...
                    <a href="<?php echo e(route('mahasiswa.proposal.create')); ?>" class="btn action-btn btn-responsive w-100 fw-bold">
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card h-100 border-0 shadow hover-card action-card gradient-purple rounded-3">
                <div class="card-body text-center card-body-responsive unified-card">
                    ...
                    <a href="<?php echo e(route('mahasiswa.status')); ?>" class="btn action-btn-purple btn-responsive w-100 fw-bold">
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card h-100 border-0 shadow hover-card action-card gradient-green rounded-3">
                <div class="card-body text-center card-body-responsive unified-card">
                    ...
                    <a href="<?php echo e(route('profile.edit')); ?>" class="btn action-btn-green btn-responsive w-100 fw-bold">
                                        ...
                                        <tr class="border-bottom border-light">
                                            <td class="table-cell-responsive fw-semibold">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="dosen-name"><?php echo e($kjfd->name); ?></span>
                                                </div>
                                            </td>
