            ...
            <div class="flex flex-col sm:flex-row items-center justify-between space-y-2 sm:space-y-0">
                <div class="flex flex-col">
                    <div class="flex items-center space-x-2">
                        <img src="<?php echo e(asset('images/unri.png')); ?>" alt="Universitas Riau Logo" class="h-[52px] xs:h-[62px] sm:h-[73px] align-middle">
                        <a href="<?php echo e(url('/')); ?>" class="text-sm xs:text-base sm:text-lg md:text-xl font-bold text-gray-900 hover:text-blue-600 transition-colors">Sistem OneSubmit</a>
                    </div>
                ...
                <div class="flex flex-wrap justify-center sm:justify-end space-x-1 xs:space-x-2 sm:space-x-4">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/dashboard')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-1 px-2 xs:py-1 xs:px-3 sm:py-2 sm:px-6 rounded-lg transition duration-300 text-xs xs:text-sm sm:text-base">
                            Dashboard
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('judul-skripsi')); ?>" class="bg-blue-400 hover:bg-blue-500 text-white font-semibold py-1 px-2 xs:py-1 xs:px-3 sm:py-2 sm:px-6 rounded-lg transition duration-300 text-xs xs:text-sm sm:text-base">
                            Judul Skripsi
                        </a>
                        <a href="<?php echo e(route('dosen-staff')); ?>" class="bg-blue-400 hover:bg-blue-500 text-white font-semibold py-1 px-2 xs:py-1 xs:px-3 sm:py-2 sm:px-6 rounded-lg transition duration-300 text-xs xs:text-sm sm:text-base">
                            Dosen dan Staff
                        </a>
                        <a href="<?php echo e(route('login')); ?>" class="bg-blue-400 hover:bg-blue-500 text-white font-semibold py-1 px-2 xs:py-1 xs:px-3 sm:py-2 sm:px-6 rounded-lg transition duration-300 text-xs xs:text-sm sm:text-base">
                            Masuk
                        </a>
                        <a href="<?php echo e(route('register')); ?>" class="bg-blue-400 hover:bg-blue-500 text-white font-semibold py-1 px-2 xs:py-1 xs:px-3 sm:py-2 sm:px-6 rounded-lg transition duration-300 text-xs xs:text-sm sm:text-base">
                            Daftar
                        </a>
                    <?php endif; ?>
                </div>
    ...
    <main class="py-6 sm:py-8 lg:py-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden animate-fadeIn border border-gray-200">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div>
                            ...
                            <p class="text-sm sm:text-base text-blue-100 flex items-center">
                                ...
                                Total: <span class="font-bold ml-1" id="totalCount"><?php echo e($approvedProposals->count()); ?></span> judul terverifikasi
                            </p>
                        </div>
                        <div class="flex items-center space-x-2">
                ...
                <?php if($approvedProposals->count() > 0): ?>
                    <div class="overflow-x-auto">
                        <table id="judulSkripsiTable" class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                <?php $__currentLoopData = $approvedProposals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 transition-all duration-300 group">
                                        ...
                                        <td class="px-6 py-5 whitespace-nowrap">
                                            <span class="inline-flex items-center px-4 py-2 text-xs sm:text-sm font-semibold rounded-xl shadow-sm
                                                <?php echo e($proposal->bidang_minat === 'Information Management' ? 'bg-gradient-to-r from-blue-100 to-blue-200 text-blue-800 border-2 border-blue-300' : ''); ?>

                                                <?php echo e($proposal->bidang_minat === 'Data Engineering' ? 'bg-gradient-to-r from-purple-100 to-purple-200 text-purple-800 border-2 border-purple-300' : ''); ?>

                                                <?php echo e($proposal->bidang_minat === 'Information Retrieval' ? 'bg-gradient-to-r from-green-100 to-green-200 text-green-800 border-2 border-green-300' : ''); ?>

                                                <?php echo e($proposal->bidang_minat === 'Business Intelligence' ? 'bg-gradient-to-r from-amber-100 to-amber-200 text-amber-800 border-2 border-amber-300' : ''); ?>

                                                <?php echo e(!in_array($proposal->bidang_minat, ['Information Management', 'Data Engineering', 'Information Retrieval', 'Business Intelligence']) ? 'bg-gradient-to-r from-gray-100 to-gray-200 text-gray-800 border-2 border-gray-300' : ''); ?>
...
<?php /**PATH C:\laragon\www\OneSubmit\resources\views/judul-skripsi.blade.php ENDPATH**/ ?>